namespace Entidades
{
    public class Postgrado: Estudiante
    {
        ...
        public Postgrado(int noDocumento, string nombre, string apellido, 
            string programa, int semestre, double promedioSemestre
        ...
        {
            return $"POST;{NoDocumento};" +
                   $"{Nombre};{Apellido};{Programa};{Semestre};{PromedioSemestre}";
        }
